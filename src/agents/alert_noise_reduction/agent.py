...
from .config import AGENT_CONFIG, AGENT_CONFIG_CHAT
...
@register_agent("alert_chat_bot")
class chatbot(BaseAgent):
    """
    聊天智能助手

    可以通过深度搜索，rag，以及mcp等工具来实现聊天交互
    """

    def __init__(self):
        super().__init__(AGENT_CONFIG_CHAT)
